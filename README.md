...
После установки Docker необходимо зайти в настройки<br>
 <br>
 ![Настройки докера]([https://github.com/WWnotLL/ROS2_tutorial_305/blob/main/изображения%20к%20тексту/Формальная%20схема%20Docker](https://github.com/WWnotLL/ROS2_tutorial_305/blob/main/изображения%20к%20тексту/настройки%20докера.png))
 <br>
